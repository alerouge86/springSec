...
import com.alerouge.kyivent.model.table.NazioneEntity;
...
public class EventEntity {
    ...
    @ManyToOne
    @JoinColumn(name="cittaId", nullable=false, insertable=false, updatable=false)
    ...
    @ManyToOne
    @JoinColumn(name="userIdCreazione", insertable=false, updatable=false, nullable=false)
    private UserEntity userCreazione;
	...
	public UserEntity getUserCreazione() {
		return userCreazione;
	}

	public void setUserCreazione(UserEntity userCreazione) {
